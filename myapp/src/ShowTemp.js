                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">{(text.temp-'273.15').toFixed(2)} °C</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">{(text.temp_min-'273.15').toFixed(2)} °C</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">{(text.temp_max-'273.15').toFixed(2)} °C</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
